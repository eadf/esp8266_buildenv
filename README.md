...
This is (or will be) the build environment i use to compile, flash and test applications on the esp8266.

I don't expect this to be useful for anybody but me, but maybe you will find it useful.
